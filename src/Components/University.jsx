    ...
    <div className={classes.root}>
      <div className="container pt-5">
        ...
        <p>
          ...
          the University. University has introduced digitalized evaluation
          system over the last few years that has brought in a sea- change in
          the publication of result precisely ahead of the schedule, thereby
          increasing substantially the available time for teaching and
          interaction with the students.
        </p>
        <p>
          Owing to the different reformative measures adopted by the university,
          WORLD MANAGEMENT CONGRESS, Higher Education and Development Summit,
          conferred “EMERGING TECHNOLOGICAL UNIVERSITY OF THE YEAR AWARD” on
          30th Dec 2011 during the global meet held at world Management Congress
          New Delhi. The Chief Minister, Chhattisgarh has expressed his
