  ...
  return (
    <div className="container pt-5" id="Coordinators">
      <div className="text-center pb-3">
        ...
        <h4>Shri I.P. Mishra</h4>
        <h4>(Chairman, SGES)</h4>
        <h4>Shri Nishant Tripathi</h4>
        <h4>(Chairman (BG), SSIPMT, Raipur)</h4>
        <h4>Dr. Alok Kumar Jain</h4>
        <h4>(Principal, SSIPMT, Raipur)</h4>
      </div>
      <div className="row">
        <div className="col-md-6 col-sm-12">
          <div className="text-center pb-3">
            ...
            <h4>Dr. J P Patra</h4>
            <h4>(Department of CSE, SSIPMT, Raipur)</h4>
            <h4>Mobile No.8319527740 (9522219109, Whatsapp) </h4>
            <h4>Email: jp.patra@ssipmt.com</h4>
          </div>
        </div>
        <div className="col-md-6 col-sm-12">
          <div className="text-center pb-3">
            <h3 className="text-primary pb-3">Program Co-Coordinator</h3>
            <h4>Mr. Anand Tamrakar</h4>
            <h4>(Department of CSE, SSIPMT, Raipur)</h4>
