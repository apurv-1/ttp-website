      ...
      <div className="container pt-5" id="programme">
        ...
        <div>
          ...
          <p className="word-align">
            The objective of the proposed FDP is to Familiarize the faculties with the concept of
            outcome-based education with more focus on adaption and implementation. To bring out the
            advantage of OBE over conventional education and focus on higher-order learning and
            professional skills necessitate a paradigm shift in traditional practices of curriculum
            design, education delivery, and assessment.
          </p>
          <h3 className="text-danger pb-3">Outcome</h3>
          <p>After the completion of the FDP the participants would be able to Understand</p>
          <ul className={classes.list}>
            ...
            <li>Teaching Learning Process and Innovation Ecosystem Strategies with Academic R&D</li>
          </ul>
        </div>
      </div>
    </div>
